    ...
    return new Column(children: <Widget>[
      ...
      Container(
          ...
          child: Row(
            children: <Widget>[
              SizedBox(width: 20),
              new Text("Actividades Relacionadas",
          ...
          children: <Widget>[
            SizedBox(
              ...
              child: Card(
                ...
                child: Column(
                  children: <Widget>[
                    Image.asset('img/img8.png', height: 80, fit: BoxFit.fill),
                    Text("Habilidades de autoregulación",
                        style: TextStyle(color: $colorTitle)),
                    Text("3 a 5 años", style: TextStyle(color: $colorSubtitle)),
                  ],
                ),
              ),
            ),
            SizedBox(
              ...
              child: Card(
                ...
                child: Column(
                  children: <Widget>[
                    Image.asset('img/img1.png', height: 80, fit: BoxFit.fill),
            ...
            SizedBox(
              ...
              child: Card(
                ...
                child: Column(
                  children: <Widget>[
                    Image.asset('img/img2.png', height: 80, fit: BoxFit.fill),
              ...
              title: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 10),
                      new Text(
                          "Las actividades fueron muy utiles para fomentar el lenguaje de mi hijo...",
                          textAlign: TextAlign.left,
                          style: TextStyle(color: $black))
                    ],
                  )),
